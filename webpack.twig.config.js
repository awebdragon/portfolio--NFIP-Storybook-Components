...
const nfip = walk("/packages/nfip/nfip-components", ".twig");
const files = [].concat(components, templates, nfip);
    ...
    rules: [
      {
        ...
        resolve: {
          alias: {
            ...
            "@nfip-components": path.resolve(
              __dirname,
              "/packages/nfip/nfip-components"
            ),
            "@nfip-templates": path.resolve(
              __dirname,
              "/packages/nfip/nfip-templates"
            ),
            "@nfip-pages": path.resolve(__dirname, "/packages/nfip/nfip-pages"),
          },
        },
      },
    ],
